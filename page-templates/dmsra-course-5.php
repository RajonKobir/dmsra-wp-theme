        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="courses-details-images">
                    <img src="<?php echo DMSRA_THEME_URL . 'assets/public/images/teacher-banners/banner-5.jpg';  ?>">
                </div>
                <h3 class="title">
                    MicroSoft Office Application (Online + Offline Course) 
                </h3>
            </div>
            <div class="col-lg-4">
                <div class="course-details-sidebar-wrapper">
                    <div class="course-price-outer">
                        <span class="price">2,500.00 BDT (Online)</span>
                        <span class="price">3,000.00 BDT (Offline)</span>
                    </div>
                    <ul>
                        <li>
                            <i class="fas fa-user"></i>
                            <strong>Instructor</strong> <span>Sumon Kazi</span>
                        </li>
                        <li>
            ...
            <?php echo $dmsra_options["dmsra_courses_course_5_description"]; ?>
