                    ...
                    <div id="o_wblog_posts_loop_container" class="col ">
                        ...
                        <div id="o_wblog_posts_loop" class="loop-grid">
                            <div class="row ">
                                ...
                                <?php 
                                    $col_lg_value = 3;
                                    if( isset($dmsra_options["dmsra_blog_posts_column_number"]) ){
                                        $number_of_columns = $dmsra_options["dmsra_blog_posts_column_number"];
                                        $col_lg_value = 12 / (int)$number_of_columns;
                                    }
                                ?>

                                <article class="col-xl-<?php echo $col_lg_value; ?> col-lg-<?php echo $col_lg_value; ?> col-md-6 text-center hover-up mb-30 animated" style="border: 1px solid #dfdede30;border-radius: 8px;">
                                <div class="post-thumb">
                                    <a href="<?php the_permalink(); ?>">
                                        <img class="border-radius-15" src="<?php echo get_the_post_thumbnail_url(get_the_ID(), 'full' ); ?>" alt="<?php the_title(); ?>" style="object-fit: cover;max-height: 177px;">
                                    </a>
                                </div>
