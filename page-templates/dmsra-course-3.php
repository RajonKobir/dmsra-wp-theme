        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="courses-details-images">
                    <img src="<?php echo DMSRA_THEME_URL . 'assets/public/images/teacher-banners/banner-3.jpg';  ?>">
                </div>
                <h3 class="title">
                    Spoken English (Online + Offline Course) 
                </h3>
            </div>
            <div class="col-lg-4">
                <div class="course-details-sidebar-wrapper">
                    <div class="course-price-outer">
                        <span class="price">2,000.00 BDT (Online)</span>
                        <span class="price">2,500.00 BDT (Offline)</span>
                    </div>
                    <ul>
                        <li>
                            <i class="fas fa-user"></i>
                            <strong>Instructor</strong> <span>Tasfia Taskin Tuli</span>
                        </li>
                        <li>
                            <i class="far fa-clock"></i>
                             <strong>Duration</strong> <span>3+ Month</span>
                        </li>
                        <li>
                            <i class="fas fa-video"></i>
                             <strong>Lectures</strong> <span>30 + Lectures</span>
                        </li>
                        <li>
                            <i class="fas fa-book"></i>
                             <strong>Language</strong> <span>Bangla + English</span>
                        </li>
                        <li>
            ...
            <?php echo $dmsra_options["dmsra_courses_course_3_description"]; ?>
