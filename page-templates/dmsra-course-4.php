        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="courses-details-images">
                    <img src="<?php echo DMSRA_THEME_URL . 'assets/public/images/teacher-banners/banner-4.jpg';  ?>">
                </div>
                <h3 class="title">
                    AutoCad With Steel Structure Design (Online + Offline Course) 
                </h3>
            </div>
            <div class="col-lg-4">
                <div class="course-details-sidebar-wrapper">
                    ...
                    <ul>
                        <li>
                            ...
                            <strong>Instructor</strong> <span>Ahsan Habib Ruyal</span>
                        </li>
                        <li>
            ...
            <?php echo $dmsra_options["dmsra_courses_course_4_description"]; ?>
