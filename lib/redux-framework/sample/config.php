...
$args = array(
	...
	'menu_title'                => esc_html__( 'DMSRA Options', DMSRA_THEME_TEXT_DOMAIN ),

	// The text to appear on the page title.
	'page_title'                => esc_html__( 'DMSRA Options', DMSRA_THEME_TEXT_DOMAIN ),
	...
	'admin_bar_icon'            => 'dashicons-admin-site-alt2',
	...
	'footer_credit'             => '<span id="footer-thankyou">' . sprintf(
			__( '%1$s WP Theme, build by %2$s', 'redux-framework' ),
			'<strong>' . __( 'dmsra', 'redux-framework' ) . '</strong>',
			'<a href="https://github.com/RajonKobir" target="_blank">Rajon Kobir</a>'
		) . '</span>',
...
// 	'id'    => 'redux-docs',
// 	'href'  => '//devs.redux.io/',
// 	'title' => __( 'Documentation', DMSRA_THEME_TEXT_DOMAIN ),
// );

// $args['admin_bar_links'][] = array(
// 	'id'    => 'redux-support',
// 	'href'  => '//github.com/ReduxFramework/redux-framework/issues',
// 	'title' => __( 'Support', DMSRA_THEME_TEXT_DOMAIN ),
// );
...
if ( ! isset( $args['global_variable'] ) || false !== $args['global_variable'] ) {
	...
	// $args['intro_text'] = '<p>' . sprintf( esc_html__( 'Did you know that Redux sets a global variable for you? To access any of your saved options from within your code you can use your global variable: $%1$s', DMSRA_THEME_TEXT_DOMAIN ), '<strong>' . $v . '</strong>' ) . '<p>';
	$args['intro_text'] = '<p>' . sprintf( esc_html__( 'Global variable: $%1$s', DMSRA_THEME_TEXT_DOMAIN ), '<strong>' . $v . '</strong>' ) . '<p>';
} else {
	$args['intro_text'] = '<p>' . esc_html__( 'This text is displayed above the options panel. It isn\'t required, but more info is always better! The intro_text field accepts all HTML.', DMSRA_THEME_TEXT_DOMAIN ) . '</p>';
}

// // Add content after the form.
// $args['footer_text'] = '<p>' . esc_html__( 'This text is displayed below the options panel. It isn\'t required, but more info is always better! The footer_text field accepts all HTML.', DMSRA_THEME_TEXT_DOMAIN ) . '</p>';
...
// 	array(
// 		'id'      => 'redux-help-tab-1',
// 		'title'   => esc_html__( 'Theme Information 1', DMSRA_THEME_TEXT_DOMAIN ),
// 		'content' => '<p>' . esc_html__( 'This is the tab content, HTML is allowed.', DMSRA_THEME_TEXT_DOMAIN ) . '</p>',
// 	),
// 	array(
// 		'id'      => 'redux-help-tab-2',
// 		'title'   => esc_html__( 'Theme Information 2', DMSRA_THEME_TEXT_DOMAIN ),
// 		'content' => '<p>' . esc_html__( 'This is the tab content, HTML is allowed.', DMSRA_THEME_TEXT_DOMAIN ) . '</p>',
// 	),
// );
...
// $content = '<p>' . esc_html__( 'This is the sidebar content, HTML is allowed.', DMSRA_THEME_TEXT_DOMAIN ) . '</p>';
...
// dmsra all configs are here 
require_once Redux_Core::$dir . '../sample/dmsra-config.php';


// Redux::set_section(
// 	$opt_name,
// 	array(
// 		'title'            => esc_html__( 'Basic Fields', DMSRA_THEME_TEXT_DOMAIN ),
// 		'id'               => 'basic',
// 		'desc'             => esc_html__( 'These are really basic fields!', DMSRA_THEME_TEXT_DOMAIN ),
...
// 	$opt_name,
// 	array(
// 		'title'            => esc_html__( 'Editors', DMSRA_THEME_TEXT_DOMAIN ),
// 		'id'               => 'editor',
...
// 	$opt_name,
// 	array(
// 		'title' => esc_html__( 'Color Selection', DMSRA_THEME_TEXT_DOMAIN ),
// 		'id'    => 'color',
// 		'icon'  => 'el el-brush',
// 	)
// );
...
// 	$opt_name,
// 	array(
// 		'title' => esc_html__( 'Design Fields', DMSRA_THEME_TEXT_DOMAIN ),
// 		'id'    => 'design',
// 		'icon'  => 'el el-wrench',
// 	)
// );
...
// 	$opt_name,
// 	array(
// 		'title' => esc_html__( 'Media Uploads', DMSRA_THEME_TEXT_DOMAIN ),
// 		'id'    => 'media',
// 		'icon'  => 'el el-picture',
// 	)
// );
...
// 	$opt_name,
// 	array(
// 		'title' => esc_html__( 'Presentation Fields', DMSRA_THEME_TEXT_DOMAIN ),
// 		'id'    => 'presentation',
// 		'icon'  => 'el el-screen',
// 	)
// );
...
// 	$opt_name,
// 	array(
// 		'title' => esc_html__( 'Switch / Button Set', DMSRA_THEME_TEXT_DOMAIN ),
// 		'id'    => 'switch_buttonset',
// 		'icon'  => 'el el-cogs',
// 	)
// );
...
// 	$opt_name,
// 	array(
// 		'title' => esc_html__( 'Select Fields', DMSRA_THEME_TEXT_DOMAIN ),
// 		'id'    => 'select',
// 		'icon'  => 'el el-list-alt',
// 	)
// );
...
// 	$opt_name,
// 	array(
// 		'title' => esc_html__( 'Slider / Spinner', DMSRA_THEME_TEXT_DOMAIN ),
// 		'id'    => 'slider_spinner',
...
// 	$opt_name,
// 	array(
// 		'title' => esc_html__( 'Additional Types', DMSRA_THEME_TEXT_DOMAIN ),
// 		'id'    => 'additional',
// 		'icon'  => 'el el-magic',
// 	)
// );
...
// 	$opt_name,
// 	array(
// 		'title' => esc_html__( 'Advanced Features', DMSRA_THEME_TEXT_DOMAIN ),
...
// 	$opt_name,
// 	array(
// 		'title' => esc_html__( 'Disabling', DMSRA_THEME_TEXT_DOMAIN ),
// 		'icon'  => 'el el-lock',
// 	)
// );
...
// 	$opt_name,
// 	array(
// 		'title' => esc_html__( 'Redux Extensions', DMSRA_THEME_TEXT_DOMAIN ),
// 		'id'    => 'redux-extensions',
// 		'icon'  => 'el el-redux',
// 		'class' => 'pro_highlight',
// 		'desc'  => esc_html__( 'For full documentation on this field, visit: ', DMSRA_THEME_TEXT_DOMAIN ) . '<a href="https://devs.redux.io/core-extensions/" target="_blank">https://devs.redux.io/core-extensions/</a>',
// 	)
// );
...
// 	$section = array(
// 		'icon'   => 'el el-list-alt',
// 		'title'  => esc_html__( 'Documentation', DMSRA_THEME_TEXT_DOMAIN ),
// 		'fields' => array(
// 			array(
...
// 	array(
// 		'icon'            => 'el el-list-alt',
// 		'title'           => esc_html__( 'Customizer Only', DMSRA_THEME_TEXT_DOMAIN ),
// 		'desc'            => '<p class="description">' . esc_html__( 'This Section should be visible only in Customizer', DMSRA_THEME_TEXT_DOMAIN ) . '</p>',
// 		'customizer_only' => true,
// 		'fields'          => array(
// 			array(
// 				'id'              => 'opt-customizer-only',
// 				'type'            => 'select',
// 				'title'           => esc_html__( 'Customizer Only Option', DMSRA_THEME_TEXT_DOMAIN ),
// 				'subtitle'        => esc_html__( 'The subtitle is NOT visible in customizer', DMSRA_THEME_TEXT_DOMAIN ),
// 				'desc'            => esc_html__( 'The field desc is NOT visible in customizer.', DMSRA_THEME_TEXT_DOMAIN ),
// 				'customizer_only' => true,
// 				'options'         => array(
// 					'1' => esc_html__( 'Opt 1', DMSRA_THEME_TEXT_DOMAIN ),
// 					'2' => esc_html__( 'Opt 2', DMSRA_THEME_TEXT_DOMAIN ),
// 					'3' => esc_html__( 'Opt 3', DMSRA_THEME_TEXT_DOMAIN ),
// 				),
// 				'default'         => '2',
// 			),
// 		),
...
if ( ! function_exists( 'dynamic_section' ) ) {
	...
	function dynamic_section( array $sections ): array {
		$sections[] = array(
			'title'  => esc_html__( 'Section via hook', DMSRA_THEME_TEXT_DOMAIN ),
			'desc'   => '<p class="description">' . esc_html__( 'This is a section created by adding a filter to the sections array. Can be used by child themes to add/remove sections from the options.', DMSRA_THEME_TEXT_DOMAIN ) . '</p>',
...
if ( ! function_exists( 'change_defaults' ) ) {
	...
	function change_defaults( array $defaults ): array {
		$defaults['str_replace'] = esc_html__( 'Testing filter hook!', DMSRA_THEME_TEXT_DOMAIN );
